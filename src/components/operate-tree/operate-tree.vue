<template>
  <div class="operate-tree">
    ...
    <div :style="{ height: `${this.clientHeight - 230}px`,overflowY: 'auto'}">
      <el-tree
        :data="data"
        ref="operateTree"
        :node-key="value"
      ...
      <span class="custom-tree-node" slot-scope="{ node, data }">
        <span>
          ...
          <span v-if="currData===data[value]">
            ...
            <Icon type="ios-compose-outline" @click.stop="editNode(data,node)" v-if="nodeEdit && data[value]!==1" size="16" class="operate-btn"></Icon>
            <Icon type="android-delete" @click.stop="delNode(data,node)" v-if="nodeDel && data[value]!==1" size="16" class="operate-btn"></Icon>
          </span>
        </span>
        <!--<span >
